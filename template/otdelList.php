...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Список отедлов</h1>
          </div><!-- /.col -->
        
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="index.php">Домой</a></li>
            <li class="mr-2 breadcrumb-item"><a href="studentList.php">Отделы</a></li>
...
<table class="table">
  ...
  <?php foreach($get as $item): ?>
    ...
    <tr>
    <td><a href="otdel-profile.php?id=<?=$item[0] ?>"> <?=$item['otdelName'] ?> </a></td>
