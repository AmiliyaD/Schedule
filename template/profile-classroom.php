 ...
 <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid bg-white pt-2 pl-2 pr-2 pb-2">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Просмотр аудиторий</h1>
          </div><!-- /.col -->
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item "><a href="otdel-profile.php">Просмотр аудиторий</a></li>
            </ol>
  ...
  <li class="nav-item">
   <b> <p  class="nav-link">Заблокирован</p></b>
            ...
            <ul class="nav flex-column">
  <li class="nav-item">
<p  class="nav-link"><?=$findProfile['classroomName'] ?> </p>
  </li>
